...
This project follow the CRUV pattern, created by James K Nelson (Inspired on Ruby on Rails)
...
- [Routers](#sending-feedback)
- [Utils](#folder-structure)
- [Views](#available-scripts)
...
The idea behind the project is apply the CRUV pattern to a real app, in this case
Fit Macros Calculator.
